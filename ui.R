shinyUI(fluidPage(
    ...
    titlePanel("Song Lyric Co-occurrence"),
        ...
        mainPanel(
            tabsetPanel(
                ...
                tabPanel("Help",
                         ...
                         p("In the ", strong("Plot"), " tab you will find a directed graph of the lyric line co-occurrence
                         ...
                         p("If the requested song is not found (typo, information supplied is incorrect), the cover art will
                           be updated with a message to inform you that the song was not found. The ", strong("Data"),
                           " and", strong("Plot"), "tabs will not be updated until a song has been successfully found."))
            )
        )
    )
))
